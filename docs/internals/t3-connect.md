...
T3CODE_PORT=13773 \
  "/Applications/Z3 (Alpha).app/Contents/MacOS/Z3 (Alpha)"
```
...
```sh
codesign --verify --deep --strict "/Applications/Z3 (Alpha).app"
codesign -d --entitlements :- "/Applications/Z3 (Alpha).app"
```

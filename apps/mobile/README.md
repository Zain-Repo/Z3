...
> [!WARNING]
> Z3 Mobile is currently in development and is not distributed yet. If you want to try it out, you can build it from source.
...
- `development`: Expo dev client, installable side-by-side as `Z3 Dev`
- `preview`: persistent internal preview build, installable side-by-side as `Z3 Preview`
- `production`: store/release build as `Z3`

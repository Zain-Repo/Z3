...
const DEVELOPMENT_ASSETS = {
  ...
  androidAdaptiveBackgroundColor: "#312E81",
    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Z3 agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Z3 to connect to Z3 servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Z3 to access your camera so you can scan pairing QR codes.",

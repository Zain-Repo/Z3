...
function getGnomeKeyringRemediationMessage(): string {
  return "Z3 could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Z3.";
}

function getKWalletRemediationMessage(): string {
  return "Z3 could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Z3.";
}

            ...
            <section className="grid gap-2">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Text and code files are added as reference context.</p>
                </div>
                <Button
                  type="button"
                  size="sm"
                ...
                <div className="divide-y rounded-lg border border-border/70">
                  {project.sources.map((source) => (
                    <div key={source.id} className="flex items-center gap-2 px-3 py-2">
                      ...
                      <span className="text-xs text-muted-foreground">{formatBytes(source.sizeBytes)}</span>
                      <Button
                        type="button"
                        size="icon-xs"
                        variant="ghost"

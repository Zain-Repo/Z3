      ...
      <div className="relative h-full w-full select-none">
        ...
        >
          <TimelineMinimapNavigationButton
            direction="previous"
            disabled={previousItem === null || hitStripWidth === 0}
            onClick={() => {
          ...
          <TimelineMinimapNavigationButton
            direction="next"
            disabled={nextItem === null || hitStripWidth === 0}
            onClick={() => {
    ...
    <Tooltip>
      <TooltipTrigger
        render={
          <span
            className={cn(
              "absolute left-1 z-10 inline-flex -translate-x-1/2 opacity-0 pointer-events-auto transition-opacity duration-150 group-hover/minimap:opacity-100 group-focus-within/minimap:opacity-100",
            ...
            {userFiles.map((file) => {
              ...
              return file.downloadUrl ? (
                <a
                  ...
                  download={file.name}
                  className="flex min-w-0 items-center gap-2 rounded-lg border border-border/70 bg-background/70 px-2.5 py-2 transition-colors hover:bg-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                ...
                <div
                  key={file.id}
                  className="flex min-w-0 items-center gap-2 rounded-lg border border-border/70 bg-background/70 px-2.5 py-2"
                >
                  {content}
                </div>
              );

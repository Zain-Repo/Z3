    ...
    <div className="px-4 py-3 sm:px-5">
      ...
      <div className="mt-3 space-y-1.5">
        {activeQuestion.options.map((option, index) => {
          ...
          const className = cn(
            "group flex w-full items-center gap-3 rounded-lg border px-3 py-2 text-left outline-none transition-[background-color,border-color,box-shadow,color] duration-150 focus-visible:border-primary/40 focus-visible:ring-1 focus-visible:ring-primary/25 motion-reduce:transition-none",
            isSelected

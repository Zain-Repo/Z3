  ...
  return (
    <div className="relative">
      ...
      {loadProgress > 0 ? (
        <div
          aria-hidden
          className="pointer-events-none absolute bottom-0 left-0 z-10 h-0.5 rounded-r-full bg-primary transition-[width] duration-150 ease-out motion-reduce:transition-none"
          style={{
            width: `${loadProgress}%`,

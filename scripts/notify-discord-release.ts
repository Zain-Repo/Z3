  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Z3 prerelease is available for nightly testers."
          : "A new Z3 latest release is available.",
...
).pipe(Command.withDescription("Post a Z3 release announcement to Discord."));

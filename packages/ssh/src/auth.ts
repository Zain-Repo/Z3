...
# Invoked by ssh via SSH_ASKPASS when Z3 re-runs ssh with a cached password
...
printf 'Z3 ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
export const ASKPASS_WINDOWS_SCRIPT = `# Invoked by ssh via SSH_ASKPASS (through ssh-askpass.cmd) when Z3 re-runs\r
...
[Console]::Error.WriteLine("Z3 ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
